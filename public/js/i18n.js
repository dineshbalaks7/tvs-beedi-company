...
const translations = {
  ta: {
    ...
    netProfitNoCommission: 'நிகர லாபம் (கமிஷன் இல்லை)',
    todayCommission: 'இன்றைய கமிஷன்',
    weeklyCommission: 'வார கமிஷன்',
      monthlyCommission: 'மாத கமிஷன்',
    commissionLabel: 'கமிஷன்',
    includeCommission: 'கமிஷனை சேர்க்கவும்',
    exportSummaryPeriod: 'காலக்கட்டம்',
    exportFilterDay: 'நாள்',
    exportFilterWeek: 'வாரம்',
    exportFilterMonth: 'மாதம்',
    profitFormulaNetProfitNoCommission: 'நிகர லாபம் (கமிஷன் இல்லை)',
    profitFormulaCommission: 'கமிஷன்',
    profitFormulaTotalProfit: 'மொத்த லாபம்',
    noCommissionFormula: 'Rate − Salary − Expenses',
    commissionBeedisHint: '10% of beedis',
    profitFormula: 'Rate மதிப்பு − சம்பளம் − செலவுகள் = லாபம்',
    monthlyOverviewTitle: 'இந்த மாத நிலவரம்',
    dailyOverviewTitle: 'தினசரி செயல்திறன் நிலவரம் (Daily Performance Overview)',
    dailyOverviewSub: 'தேர்ந்தெடுக்கப்பட்ட தினத்தின் உற்பத்தி மற்றும் நிதி நிலவரம்',
    dayBoxes: 'கட்டை (Boxes)',
    overviewDateFilter: 'தேதி',
    viewDailyDetails: 'தினசரி விவரம்',
    overviewMonthFilter: 'மாதம்',
    overviewWeekFilter: 'வாரம்',
    ...
    commissionPercentSetting: 'கமிஷன் சதவீதம் (%)',
    commissionPercentNote: 'பீடிகள் கமிஷன் சதவீதம்',
    ...
    chartProfitTrackingSub: 'Rate vs சம்பளம் vs செலவுகள் vs நிகர லாபம் (கமிஷன் இல்லை) vs கமிஷன் vs மொத்த லாபம்',
  ...
  en: {
    ...
    netProfitNoCommission: 'Net Profit (No Commission)',
    ...
    exportFilterDay: 'Day',
    exportFilterWeek: 'Week',
    exportFilterMonth: 'Month',
    profitFormulaNetProfitNoCommission: 'Net Profit (No Commission)',
    profitFormulaCommission: 'Commission',
    profitFormulaTotalProfit: 'Total Profit',
    noCommissionFormula: 'Rate − Salary − Expenses',
    commissionBeedisHint: '10% of beedis',
    profitFormula: 'Rate Amount − Salary − Expenses = Profit',
    monthlyOverviewTitle: 'This Month Overview',
    dailyOverviewTitle: 'Daily Performance Overview',
    dailyOverviewSub: 'Production and financial summary for the selected day',
    dayBoxes: 'Boxes',
    overviewDateFilter: 'Date',
    viewDailyDetails: 'Daily Details',
    overviewMonthFilter: 'Month',
    overviewWeekFilter: 'Week',
    ...
    commissionPercentSetting: 'Commission Percentage (%)',
    commissionPercentNote: 'Commission percentage applied to beedis',
    ...
    chartProfitTrackingSub: 'Rate vs Salary vs Expenses vs Net Profit (No Commission) vs Commission vs Total Profit',
